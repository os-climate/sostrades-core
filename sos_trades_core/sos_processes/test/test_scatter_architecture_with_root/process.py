...
class ProcessBuilder(BaseProcessBuilder):
    ...
    _ontology_data = {
        'label': 'sos_trades_core.sos_processes.test.test_scatter_architecture_with_root',
        'description': '',
        'category': '',
        'version': '',
    }
    def get_builders(self):
        ...
        architecture_df = pd.DataFrame(
            {'Parent': ['Services', 'Services', 'Services', 'Services', None,None],
             'Current': ['OSS', 'FHS', 'Pool', 'TSP', 'Sales','@root_node@'],
             'Type': ['SumValueBlockDiscipline', 'SumValueBlockDiscipline',
                      'SumValueBlockDiscipline', 'SumValueBlockDiscipline', 'SumValueBlockDiscipline','SumValueBlockDiscipline'],
             'Action': [('scatter', 'AC_list', ('scatter', 'subsystem_list', 'ValueBlockDiscipline')), ('scatter', 'AC_list', ('scatter', 'subsystem_list', 'ValueBlockDiscipline')), ('scatter', 'AC_list', ('scatter', 'subsystem_list', 'ValueBlockDiscipline')), ('scatter', 'AC_list', ('scatter', 'subsystem_list', 'ValueBlockDiscipline')), ('scatter', 'AC_list', ('scatter', 'subsystem_list', 'ValueBlockDiscipline')),('standard')],
             'Activation': [False, False, False, False, False,False]})
