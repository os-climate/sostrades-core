...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        anonymize_input_dict_from_usecase['<study_ph>.Disc10.Model_Type'] = 'Polynomial'
        anonymize_input_dict_from_usecase['<study_ph>.Disc10.x'] = 2.0
        anonymize_input_dict_from_usecase['<study_ph>.Disc10.b'] = 4.0

        process_builder_parameter_type = ProcessBuilderParameterType(mod_id, repo, 'usecase_polynomial')
        process_builder_parameter_type.usecase_data = anonymize_input_dict_from_usecase

        ######### Numerical values   ####

        input_selection = {'selected_input': [False, False, False, True],
