...
class Study(StudyManager):
    '''This is an example of usecase study for
     the test_scatter-disc1_disc3_vs_MS_from_proc process.
    This process instantiates the multiscenario of (scatter of the disc1_scenario, disc3_scenario).
    '''
    ...
    def setup_usecase(self):
        ...
        dict_values[f'{self.study_name}.vs_MS.scenario_1.Disc1.name_1.b'] = b1
        dict_values[f'{self.study_name}.vs_MS.scenario_1.Disc1.name_2.b'] = b2
        ...
        dict_values[f'{self.study_name}.vs_MS.scenario_2.Disc1.name_1.b'] = b1
        dict_values[f'{self.study_name}.vs_MS.scenario_2.Disc1.name_2.b'] = b2
