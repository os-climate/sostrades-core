...
from sos_trades_core.sos_wrapping.analysis_discs.uncertainty_quantification import (
...
class TestUncertaintyQuantification(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mod_path = (
            'sos_trades_core.sos_wrapping.analysis_discs.uncertainty_quantification'
        )
    ...
    def test_01_uncertainty_quantification(self):
        ...
        self.data_df = pd.read_csv(join(self.data_dir, 'data_df_2.csv'))[
            ['variable', 'npv', 'total_free_cash_flow', 'max_peak_exposure']
        ]
