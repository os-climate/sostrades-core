...
class TestSoSDOEScenario(unittest.TestCase):
    ...
    def _test_3_separated_doe_and_eval_execution_lhs_on_1_var(self):
        """
        """
    ...
    def _test_4_doe_eval_options_and_design_space_after_reconfiguration(self):
    ...
    def _test_6_doe_eval_design_space_normalisation(self):
    ...
    def _test_10_warning_in_case_of_a_wrong_inputs_outputs_in_doe_eval(self):
    ...
    def _test_13_sameusecase_name_as_doe_eval(self):
        """ We test that the number of samples generated by the fullfact algorithm is the theoretical expected number
        Pay attention to the fact that an additional sample (the reference one ) is added
        """
