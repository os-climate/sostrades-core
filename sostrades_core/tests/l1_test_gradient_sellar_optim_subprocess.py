...
from sostrades_core.sos_processes.test.test_sellar_opt_w_design_var_sub.usecase import (
    Study as study_sellar_sub,
)
from sostrades_core.sos_processes.test.test_sellar_sub_opt_w_design_var.usecase import (
    Study,
)
