...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.x'] = 22.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.y'] = 23.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.ax2'] = 24.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.by2'] = 25.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.cx'] = 26.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.dy'] = 27.0
        anonymize_input_dict_from_usecase['<study_ph>.Hessian.exy'] = 212.0

        process_builder_parameter_type = ProcessBuilderParameterType(mod_id, repo, 'usecase3')
