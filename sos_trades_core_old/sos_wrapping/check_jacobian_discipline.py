...
class CheckJacobianDiscipline(SoSDiscipline):
    ...
    _ontology_data = {
        'label': 'sostrades_core.sos_wrapping.check_jacobian_discipline',
        'type': 'Research',
    ...
    DESC_IN = {'repo_name': {'type': 'string', 'structuring': True, 'structuring': True},
               ...
               'input_column': {'type': 'list', 'subtype_descriptor': {'list': 'string'}, 'unit': '[-]', SoSDiscipline.OPTIONAL: True, SoSDiscipline.NUMERICAL: True, SoSDiscipline.USER_LEVEL: 3},
               'output_column': {'type': 'list', 'subtype_descriptor': {'list': 'string'}, 'unit': '[-]', SoSDiscipline.OPTIONAL: True, SoSDiscipline.NUMERICAL: True, SoSDiscipline.USER_LEVEL: 3},
               ...
               'inputs': {'type': 'list', 'subtype_descriptor': {'list': 'string'}, 'unit': '[-]', SoSDiscipline.OPTIONAL: True, SoSDiscipline.NUMERICAL: True, SoSDiscipline.USER_LEVEL: 3},
               'outputs': {'type': 'list', 'subtype_descriptor': {'list': 'string'}, 'unit': '[-]', SoSDiscipline.OPTIONAL: True, SoSDiscipline.NUMERICAL: True, SoSDiscipline.USER_LEVEL: 3},
               }
