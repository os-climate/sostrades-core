...
class TestCompareDict(unittest.TestCase):
    ...
    def test_03_compute_len(self):
        ...
        type_len_1 = ['int', 'np_int32', 'np_int64', 'float', 'np_float32', 'np_float64', 'np_complex128', 'bool',
                      'string', 'dict_list']

        for key in type_len_1:
            self.assertEqual(compute_len(self.data_dict_1[key]), 1)

        type_len_2 = ['string_list', 'string_list_list', 'string_dict', 'array_order', 'list', 'order_list',
                      'float_list', 'empty_dict', 'dict']
