...
class TestExtendDict(unittest.TestCase):
    ...
    def test_01_sosdiscipline_simple_dict(self):
        ...
        converted_inputs = disc5._convert_new_type_into_array(disc5_inputs, update_dm=True)
        
        # check new_types conversion into array
        for key, value in target.items():
            self.assertListEqual(value, list(converted_inputs[key]))
            
        reconverted_inputs = disc5._convert_array_into_new_type(converted_inputs)
...
#             dict_out['key1']['key14']['key141'])
    ...
    def test_03_soscoupling_simple_dict(self):
        ...
        converted_inputs = exec_eng.root_process._convert_new_type_into_array(values_dict, update_dm=True)
        
        # check new_types conversion into array
        self.assertTrue(dict_are_equal(values_dict_array, converted_inputs))
            
        reconverted_inputs = exec_eng.root_process._convert_array_into_new_type(converted_inputs)
...
#         target_array = {'EE.dict_out': [0.5, 0.5, 8.0, 0.0, 1.0, 3.0, 1.0, 2.0, 0.5, 5.0, 10.0], 'EE.z': [
...
#         target_array = {'EE.dict_out': [0.707107, 0.5, 8., 0., 1., 3.,
#                                   1., 2., 0.707107, 5., 10.],
