...
class ProcessBuilder(BaseProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Process DoE_Eval of a Hessian Discipline from the discipline',
        'description': 'Process to Instantiate the DoE_Eval of a Hessian Discipline build directly from the discipline',
        'category': '',
        'version': '',
    }
    def get_builders(self):
        mod_path = 'sostrades_core.sos_wrapping.test_discs.disc_hessian.DiscHessian'
        disc_name = 'Hessian'
