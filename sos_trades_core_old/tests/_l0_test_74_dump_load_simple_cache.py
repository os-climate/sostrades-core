...
class TestLoadSimpleCache(unittest.TestCase):
    ...
    def test_02_dump_and_load_cache_on_disc1_process(self):
        ...
        cache_pkl_path = join(dump_dir, 'sostrades_core.sos_processes.test', 'test_disc1_disc2_coupling', study_dump.study_name, 'cache.pkl')
    ...
    def test_04_dump_and_load_disc1_cache(self):
        ...
        # check dumped cache pickle existence
        cache_pkl_path = join(dump_dir, 'sostrades_core.sos_processes.test', 'test_disc1_disc2_coupling', study_1.study_name, 'cache.pkl')
        self.assertTrue(exists(cache_pkl_path))
