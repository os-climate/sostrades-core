...
class SobieskiBase(object):
    ...
    def compute_half_span(self, z):
        ...
        :rtype: numpy array
        """
        return self.math.sqrt(z[3] * z[5]) * 0.5  # 1/2 span

    def compute_thickness(self, z):
        ...
        """
        return (
            z[0] * z[5] / (self.math.sqrt(z[5] * z[3]))
        )  # thickness
