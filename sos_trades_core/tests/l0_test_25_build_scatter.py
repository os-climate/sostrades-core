...
class TestBuildScatter(unittest.TestCase):
    ...
    def test_01_build_coupling_of_scatter(self):
        ...
        self.assertListEqual([s.disc for s in scatter_list], self.exec_eng.root_process.sos_disciplines,
                             f'\nlist of scatter disciplines to build {[d.sos_name for d in scatter_list]} is different ' +
                             f'than list of built ones {[d.sos_name for d in self.exec_eng.root_process.sos_disciplines]}')
    ...
    def test_02_buil_scatter_of_coupling(self):
        ...
        self.exec_eng.display_treeview_nodes()
        self.assertListEqual(list(self.exec_eng.dm.disciplines_id_map.keys()),
                             ['MyCase', 'MyCase.scatter', 'MyCase.scatter.name_1.Disc2',
                              'MyCase.scatter.name_1.Disc1', 'MyCase.scatter.name_2.Disc2',
                              'MyCase.scatter.name_2.Disc1'])
    ...
    def test_03_build_scatter_of_scatter_of_coupling(self):
        ...
        self.assertListEqual(['MyCase',
                              ...
                              'MyCase.scatter_sc.scenario_2.name_2.Disc1'], list(self.exec_eng.dm.disciplines_id_map.keys()))
    ...
    def test_04_build_scatter_of_coupling_of_scatter(self):
        ...
        self.assertCountEqual(['MyCase', 'MyCase.scatter_sc', 'MyCase.scatter_sc.scenario_1.Disc2',
                               ...
                               'MyCase.scatter_sc.scenario_2.Disc1.name_2'], list(self.exec_eng.dm.disciplines_id_map.keys()))
    ...
    def test_05_build_coupling_of_scatter_with_auto_gather(self):
        ...
        for disc in disc1:
            if isinstance(disc, SoSDisciplineGather):
                disc1_gather = disc
