...
class Study(StudyManager):
    '''This is an example of usecase study for
     the test_proc_build_disc0 process.
    ...
    def setup_usecase(self):
        ...
        mod_id = 'test_proc_build_disc0'
        anonymize_input_dict_from_usecase = {}
        anonymize_input_dict_from_usecase['<study_ph>.Disc0.r'] = 4.5
        anonymize_input_dict_from_usecase['<study_ph>.Disc0.mod'] = 2

        process_builder_parameter_type = ProcessBuilderParameterType(mod_id, repo, 'usecase_float')
