...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        anonymize_input_dict_from_usecase['<study_ph>.Disc1.x'] = 130
        anonymize_input_dict_from_usecase['<study_ph>.Disc1.a'] = 30
        anonymize_input_dict_from_usecase['<study_ph>.Disc1.b'] = 5
        anonymize_input_dict_from_usecase['<study_ph>.Disc1.name'] = 'A1'
        anonymize_input_dict_from_usecase['<study_ph>.Disc1.x_dict'] = {
            'x_1': 1.2, 'x_2': 2.2, 'x_3': 13., 'x_4': 9.1}
