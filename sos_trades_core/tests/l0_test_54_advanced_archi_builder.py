...
class TestAdvancedArchiBuilder(unittest.TestCase):
        ...
        architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    ('standard'),
                    ('standard'),
                    ('architecture', sub_architecture_df),
                    ('standard'),
                ],
        ...
        self.exec_eng.ns_manager.add_ns_def(
            {
                ...
                'ns_Manufacturer1': f'{self.study_name}.Business.Manufacturer1',
                'ns_Manufacturer2': f'{self.study_name}.Business.Manufacturer2',
            }
        )
        ...
        sub_architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    ...
                    ('standard'),
                    ('standard'),
                    ('architecture', sub_sub_architecture_df),
                ],
                'Activation': [False, False, False, False],
            }
        )
    ...
    def test_04_build_scatter_architecture(self):
        ...
        activation_df = pd.DataFrame(
            {
                'Business': ['Manufacturer1', 'Manufacturer1', 'Manufacturer1'],
                'AC_list': ['AC1', 'AC2', 'AC3'],
        ...
        self.assertEqual(
            self.exec_eng.dm.get_disciplines_with_name(
                'MyCase.Business.Manufacturer1.Services'
            )[1].scatter_builders.cls.__name__,
            'SumValueBlockDiscipline',
        )
        self.assertEqual(
            self.exec_eng.dm.get_disciplines_with_name(
                'MyCase.Business.Manufacturer1.Services.AC1'
            )[0].__class__.__name__,
            'SumValueBlockDiscipline',
        )
        self.assertEqual(
            self.exec_eng.dm.get_disciplines_with_name(
                'MyCase.Business.Manufacturer1.Services.AC2'
            )[0].__class__.__name__,
            'SumValueBlockDiscipline',
        )
        self.assertEqual(
            self.exec_eng.dm.get_disciplines_with_name(
                'MyCase.Business.Manufacturer1.Services.AC3'
            )[0].__class__.__name__,
            'SumValueBlockDiscipline',
        )
    ...
    def test_05_build_scatter_of_scatter(self):
        ...
        architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    (
                        'scatter',
                        'AC_list',
                        ('scatter', 'component_list', 'ValueBlockDiscipline'),
                    )
                ],
                'Activation': [False],
            }
        ...
        activation_df = pd.DataFrame(
            {'AC_list': [None], 'component_list': [None], 'AC_Sales': [True]}
        )

        self.assertDictEqual(
            activation_df.to_dict(),
            self.exec_eng.dm.get_value('MyCase.Business.activation_df').to_dict(),
        )
        ...
        self.assertListEqual(
            [child.get_disc_full_name() for child in ac1_disciplines[0].children_list],
            [
        ...
        self.assertListEqual(
            [
                child.get_disc_full_name()
                for child in acsales_disciplines[0].children_list
            ],
            [
                'MyCase.Business.AC_Sales.AC1',
    ...
    def _test_08_build_scatter_under_scatter_architecture(self):
        ...
        architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    (
                        'scatter_architecture',
                        'Actor_list',
                        'SumBusinessActorValueBlockDiscipline',
                        sub_architecture_df,
                    )
                ],
                'Activation': [False],
        ...
        activation_df = pd.DataFrame(
            {
                'Actor_list': ['Manufacturer1', 'Manufacturer1', 'Manufacturer2'],
    ...
    def test_09_build_scatter_of_architecture(self):
        ...
        """
        mydict = {
            'input_name': 'actors_list',
            'input_ns': 'ns_actors',
            'output_name': 'ac_name',
            'scatter_ns': 'ns_ac',
        }  # or object ScatterMapBuild
        ...
        scatter = self.exec_eng.factory.create_scatter_builder(
            'Business', 'actors_list', [builder]
        )
        ...
        dict_values = {
            self.study_name + '.actors_list': ['Manufacturer1', 'Manufacturer2']
        }
        self.exec_eng.load_study_from_input_dict(dict_values)
        print("with Manufacturer2 and Manufacturer1 as actors")
        print(self.exec_eng.display_treeview_nodes())
        initial_tree_view = [
            f'Nodes representation for Treeview {self.namespace}',
            f'|_ {self.namespace}',
        ...
        dict_values = {self.study_name + '.actors_list': ['Manufacturer1', 'Embraer']}
        self.exec_eng.load_study_from_input_dict(dict_values)
        print("Deleting Manufacturer2 and inserting Embraer")
        print(self.exec_eng.display_treeview_nodes())
        second_tree_view = [
            f'Nodes representation for Treeview {self.namespace}',
            f'|_ {self.namespace}',
        ...
        dict_values = {self.study_name + '.actors_list': ['Comac', 'ATR']}
        self.exec_eng.load_study_from_input_dict(dict_values)
        print("Deleting Embraer and Manufacturer1 and inserting Comac and ATR")
        print(self.exec_eng.display_treeview_nodes())
        third_tree_view = [
            f'Nodes representation for Treeview {self.namespace}',
            f'|_ {self.namespace}',
        ...
        self.assertEqual(third_tree_view, self.exec_eng.display_treeview_nodes())
    ...
    def test_11_build_scatter_of_architecture_with_sub_architecture_from_process(self):
        ...
        activ_df = pd.DataFrame(
            {
                'AC_list': ['NSA-300', 'NSA-300', 'NSA-400', 'NSA-400'],
        ...
        dict_values = {
            f'{self.study_name}.Business.actors_list': [
                'Manufacturer1',
                'Manufacturer2',
            ],
            f'{self.study_name}.Business.Manufacturer1.activation_df': activ_df,
            f'{self.study_name}.Business.Manufacturer2.activation_df': activ_df,
        }
        ...
        dict_values = {
            self.study_name + '.Business.actors_list': ['Manufacturer1', 'Embraer']
        }
        ...
        dict_values = {f'{self.study_name}.Business.Embraer.activation_df': activ_df}
    ...
    def _test_12_build_scatter_of_sub_architecture_and_scatter(self):
        ...
        sub_architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    ('standard'),
                    ('standard'),
                    ('scatter', 'aircrafts_list', 'ValueBlockDiscipline'),
                    ('standard'),
                ],
                'Activation': [False, False, False, False],
            }
        ...
        self.exec_eng.load_study_from_input_dict(dict_values)
        dict_values = {self.study_name + '.aircrafts_list': ['AC1', 'AC2', 'AC3']}
    ...
    def test_13_build_scatter_of_architecture_without_father_and_with_sum_value_block(
        self,
    ):
        """
        ...
        tree_view = '\n'.join(tree_view)
        self.assertEqual(tree_view, self.exec_eng.display_treeview_nodes())

        self.exec_eng.execute()

        output_flight_hour_Manufacturer1 = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer1.Flight Hour.output'
        )
        output_flight_hour_Manufacturer2 = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer2.Flight Hour.output'
        )

        output_maintenance_Manufacturer1 = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer1.Maintenance.output'
        )

        output_maintenance_Manufacturer2 = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer2.Maintenance.output'
        )

        output_Manufacturer1_gather = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer1.output_gather'
        )
        output_Manufacturer2_gather = self.exec_eng.dm.get_value(
            'MyCase.Business.Manufacturer2.output_gather'
        )

        self.assertDictEqual(
            output_Manufacturer1_gather,
            {
                'Flight Hour': output_flight_hour_Manufacturer1,
                'Maintenance': output_maintenance_Manufacturer1,
            },
        )

        self.assertDictEqual(
            output_Manufacturer2_gather,
            {
                'Flight Hour': output_flight_hour_Manufacturer2,
                'Maintenance': output_maintenance_Manufacturer2,
            },
        )
        ...
        self.assertDictEqual(
            output_embraer_gather,
            {
                'Flight Hour': output_flight_hour_embraer,
    ...
    def test_14_build_scatter_of_sub_architecture_with_process_with_root_node(self):
        ...
        self.assertTrue(
            isinstance(
                self.exec_eng.dm.get_disciplines_with_name('MyCase.Business.Embraer')[
                    1
                ],
                ValueBlockDiscipline,
            )
        ...
        assert (
            self.exec_eng.dm.get_disciplines_with_name('MyCase.Business.Embraer')[1]
        ).children_list == []
