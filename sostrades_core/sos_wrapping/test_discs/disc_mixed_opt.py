...
if __name__ == "__main__":
    ...
    mod = 'sostrades_core.sos_wrapping.test_discs.disc_mixed_opt.DiscMixedOptLinearFeasible'
    ...
    exec_eng = ExecutionEngine("test")
    factory = exec_eng.factory
    mod = 'sostrades_core.sos_wrapping.test_discs.disc_mixed_opt.DiscMixedOptNonLinearFeasible'
    builder = factory.get_builder_from_module('DiscMixedOpt', mod)
    factory.set_builders_to_coupling_builder(builder)
    exec_eng.configure()
