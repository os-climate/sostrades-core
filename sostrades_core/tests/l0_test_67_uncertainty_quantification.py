...
class TestUncertaintyQuantification(unittest.TestCase):
    ...
    def test_01_uncertainty_quantification(self):
        ...
        self.data_dir = join(dirname(dirname(__file__)), 'sos_processes', 'test', self.proc_name, 'data')

        self.samples_dataframe = pd.read_csv(join(self.data_dir, 'samples_df.csv'))
