...
class ProcessBuilder(BaseProcessBuilder):
    def get_builders(self):
        ...
        mod_path0 = 'sostrades_core.sos_wrapping.test_discs.sos_Sobieski.SobieskiMission'
        disc_name = 'SobieskiMission'
        disc0_builder = self.ee.factory.get_builder_from_module(disc_name, mod_path0)
        
        mod_path1 = 'sostrades_core.sos_wrapping.test_discs.sos_Sobieski.SobieskiStructure'
        disc_name = 'SobieskiStructure'
        disc1_builder = self.ee.factory.get_builder_from_module(disc_name, mod_path1)
        
        mod_path2 = 'sostrades_core.sos_wrapping.test_discs.sos_Sobieski.SobieskiAerodynamics'
        disc_name = 'SobieskiAerodynamics'
        disc2_builder = self.ee.factory.get_builder_from_module(disc_name, mod_path2)
        
        mod_path3 = 'sostrades_core.sos_wrapping.test_discs.sos_Sobieski.SobieskiPropulsion'
