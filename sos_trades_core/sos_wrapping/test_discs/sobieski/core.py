...
from sos_trades_core.sos_wrapping.test_discs.sobieski.base import SobieskiBase
from sos_trades_core.sos_wrapping.test_discs.sobieski.core_aerodynamics import SobieskiAerodynamics
from sos_trades_core.sos_wrapping.test_discs.sobieski.core_mission import SobieskiMission
from sos_trades_core.sos_wrapping.test_discs.sobieski.core_propulsion import SobieskiPropulsion
from sos_trades_core.sos_wrapping.test_discs.sobieski.core_structure import SobieskiStructure
...
class SobieskiProblem(object):
    ...
    def get_default_inputs_equilibrium(self, names=None):
        ...
        input_vect = self.get_default_x0()
        indata = {
            "z": array(input_vect[4:], dtype=self.dtype),
            "y_34": array([1.10754577], dtype=self.dtype),
            "y_32": array([0.50279625], dtype=self.dtype),
    ...
    def get_sobieski_optimum(self):
        ...
        :returns: array of x optimum x_1, x_2, x_3, z concatenated
        :rtype: ndarray
        """
        return array(
    ...
    def derive_blackbox_structure(self, z, y_21, y_31, x_1, true_cstr=False):
        ...
        return self.sobieski_structure.derive_blackbox_structure(
            z, y_21, y_31, x_1, true_cstr=true_cstr
        )
    ...
    def blackbox_aerodynamics(self, z, y_12, y_32, x_2, true_cstr=False):
        ...
        return self.sobieski_aerodynamics.blackbox_aerodynamics(
            z, y_12, y_32, x_2, true_cstr=true_cstr
        )
    ...
    def blackbox_propulsion(self, z, y_23, x_3, true_cstr=False):
        ...
        return self.sobieski_propulsion.blackbox_propulsion(
            z, y_23, x_3, true_cstr=true_cstr
        )
    ...
    def blackbox_mission(self, z, y_14, y_24, y_34):
        ...
        return self.sobieski_mission.blackbox_mission(z, y_14, y_24, y_34)
    ...
    def derive_blackbox_mission(self, z, y_14, y_24, y_34):
        ...
        :rtype: dict(ndarray)
        """
        return self.sobieski_mission.derive_blackbox_mission(z, y_14, y_24, y_34)
    ...
    def systemanalysis_gauss_seidel(
        ...
        while (abs(lift_convergence - y_21[0]) > (y_21[0] * accuracy)) or (
            ...
            y_4 = self.blackbox_mission(z, y_14, y_24, y_34)
