...
from sostrades_core.sos_processes.test.tests_driver_eval.mono.test_mono_driver_sample_generator_tornado_analysis.usecase_tornado_analysis import Study
...
class TestTornadoChartAnalysis(unittest.TestCase):
    ...
    def test_01_tornado_chart_analysis(self):
        ...
        output_selection_ind = {'selected_output': [True, False, False],
        ...
        scenario_namespace = {"scenario_name":scenarios,
        ...
        samples_df = {"selected_scenario":[True]*5,
