...
class SellarSystem(MDODiscipline):
    ...
    def _run(self):  # type: (...) -> None
        ...
        obj = array(
            [self.compute_obj(x_local, x_shared, y_1, y_2)], dtype=complex128)
    ...
    def compute_obj(
        ...
        """
        return x_local[0] ** 2 + x_shared[1] + y_1[0] + exp(-y_2[0])
    ...
    def _compute_jacobian(
        ...
        x_local, _, y_1, y_2 = self.get_inputs_by_name(
            [X_LOCAL, X_SHARED, Y_1, Y_2])
        self.jac[C_1][Y_1] = atleast_2d(array([-1.0]))
        ...
        self.jac[OBJ][Y_1] = atleast_2d(array([1.0]))
...
class Sellar1(MDODiscipline):
    ...
    def compute_y_1(
        ...
        """
        return x_shared[0] ** 2 + x_shared[1] + x_local[0] - 0.2 * y_2[0]
    ...
    def _compute_jacobian(
        ...
        self.jac[Y_1] = {}
        self.jac[Y_1][X_LOCAL] = atleast_2d(array([1.0]))
        self.jac[Y_1][X_SHARED] = atleast_2d(
            array([2.0 * x_shared[0], 1.0])
        )
        self.jac[Y_1][Y_2] = atleast_2d(array([-0.2]))
...
class Sellar2(MDODiscipline):
    ...
    def _run(self):  # type: (...) -> None
        ...
        if self.residual_form:
            ...
            r_2_out = array(
                [self.compute_r_2(x_shared, y_1, y_2)], dtype=complex128)
    ...
    def compute_y_2(
        ...
        """
        out = x_shared[0] + x_shared[1] + sqrt(y_1[0])
        return out
