...
class TestSoSProcessFactory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        set up tests
        '''
        # All this test are based on sos_trades_core.sos_processes.test
        self.name = 'TestSoSFactory'
        self.repository_to_check = 'sos_trades_core.sos_processes.test'
        self.raw_repository = 'sos_trades_core.sos_processes'
    ...
    def test_03_list_test_modules(self):
        ...
        target_list = ['test_coupling_of_scatter', 'test_disc1', 'test_disc1_disc2_coupling',
