...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        # reference value (computed in any case)
        dict_values[f'{prefix}.scenario_1.Disc3.z'] = z_1
        ...
        # reference value (computed in any case)
        dict_values[f'{prefix}.scenario_2.Disc3.z'] = z_2
        ...
        dict_values[f'{prefix}.scenario_1.DoE_Eval.algo_options'] = {
            'n_samples': n_samples}
        dict_values[f'{prefix}.scenario_2.DoE_Eval.design_space'] = dspace_z
        dict_values[f'{prefix}.scenario_2.DoE_Eval.algo_options'] = {
            'n_samples': n_samples}
