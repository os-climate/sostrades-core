...
class Disc1(SoSDiscipline):
    ...
    _ontology_data = {
        'label': 'sostrades_core.sos_wrapping.test_discs.disc1_dict',
        'type': 'Research',
    ...
    _maturity = 'Fake'
    DESC_IN = {
        'x_list': {'type': 'list', 'subtype_descriptor': {'list': 'float'}, 'visibility': SoSDiscipline.SHARED_VISIBILITY, 'namespace': 'ns_ac'},
        'a': {'type': 'float'},
        'b': {'type': 'float'}
    }
    DESC_OUT = {
