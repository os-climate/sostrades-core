...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        builder_list = self.create_builder_list(mods_dict, ns_dict={'ns_OptimSellar': self.ee.study_name + '.SellarOptimScenario'})
        opt_builder = self.ee.factory.create_optim_builder('SellarOptimScenario', builder_list)
