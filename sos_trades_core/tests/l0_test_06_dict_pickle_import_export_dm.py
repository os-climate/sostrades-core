...
from sos_trades_core.tools.tree.serializer import DataSerializer, CSV_SEP, FILE_URL, generate_unique_data_csv
...
class TestSerializeDF(unittest.TestCase):
    ...
    def init_and_configure_ee(self, st_name, ns_dict, db_dir=None, rw_obj=None):
        ...
        mod_list = 'sos_trades_core.sos_wrapping.test_discs.disc_all_types.DiscAllTypes'
