...
class CheckDataIntegrity():
    ...
    def __check_variable_range(self, var_name, var_data_dict):
        '''
    ...
    def __check_range_type_vs_value_type(self, var_name, value, variable_range):
        '''
    ...
    def __check_possible_values(self, var_name):
        '''
    ...
    def __check_dataframe_descriptor(self, var_name, var_data_dict):
        '''
    ...
    def __check_dataframe_column_with_df_descriptor(self, column, column_descriptor, var_name, key):
        '''
    ...
    def __check_subtype_descriptor(self, var_name, var_data_dict):
        '''
        ...
        if self.SUBTYPE in var_data_dict:
            variable_subtype = var_data_dict[self.SUBTYPE]
            self.__check_subtype(var_name, variable_subtype, self.variable_type,
                                 self.variable_value)

    def __check_subtype(self, var_name, subtype, type_to_check, variable_value):
