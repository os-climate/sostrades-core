...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        y_1 = pd.DataFrame({'years': np.arange(1, 5), 'value_a': 1.0, 'value_b': 0.2})
        y_2 = pd.DataFrame({'years': np.arange(1, 5), 'value': 1.0})
        ...
        disc_dict[f'{ns}.{coupling_name}.y_1'] = y_1
        disc_dict[f'{ns}.{coupling_name}.y_2'] = y_2
