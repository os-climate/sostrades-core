...
class ProcessBuilder(BaseProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Core Test Very Simple Multi Scenario Process of (Disc1,Disc3) with business_post_proc',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        multi_scenarios = self.ee.factory.create_very_simple_multi_scenario_builder(
            driver_name, scenario_map_name, builder_list, autogather=False, gather_node='Post-processing', business_post_proc=True)
