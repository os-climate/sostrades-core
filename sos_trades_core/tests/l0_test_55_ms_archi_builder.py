...
class TestMultiScenarioArchiBuilder(unittest.TestCase):
    ...
    def test_01_very_simple_multi_scenario_of_simple_architecture(self):
        ...
        architecture_df = pd.DataFrame(
            {
                'Parent': ['Business', 'Manufacturer1'],
                'Current': ['Manufacturer1', 'AC_Sales'],
        ...
        self.exec_eng.ns_manager.add_ns_def(
            {
                'ns_public': f'{self.study_name}.multi_scenarios',
        ...
        activation_df_1 = pd.DataFrame(
            {
                'Business': ['Manufacturer1', 'Manufacturer1'],
                'AC_list': ['AC1', 'AC2'],
                'AC_Sales': [True, True],
            }
        )

        activation_df_2 = pd.DataFrame(
            {
                'Business': ['Manufacturer1', 'Manufacturer1'],
                'AC_list': ['AC3', 'AC4'],
                'AC_Sales': [True, True],
        ...
        dict_values = {
            f'{self.study_name}.multi_scenarios.scenario_1.Business.activation_df': activation_df_1,
        ...
        self.assertListEqual(
            list(
                self.exec_eng.dm.get_value(
                    'MyCase.multi_scenarios.scenario_1.Business.Manufacturer1.AC_Sales.AC_list'
                )
            ),
            ['AC1', 'AC2'],
        )
        self.assertListEqual(
            list(
                self.exec_eng.dm.get_value(
                    'MyCase.multi_scenarios.scenario_2.Business.Manufacturer1.AC_Sales.AC_list'
                )
            ),
            ['AC3', 'AC4'],
        )
    ...
    def test_02_very_simple_multi_scenario_of_architecture_scatter_of_scatter(self):
        ...
        subsystem_services_map_dict = {
            'input_name': 'subsystems_list',
            'input_ns': 'ns_scenario',
        ...
        architecture_df = pd.DataFrame(
            {
                ...
                'Action': [
                    ...
                    (
                        'scatter',
                        'AC_list',
                        ('scatter', 'subsystems_list', 'ValueBlockDiscipline'),
                    ),
                    (
                        'scatter',
                        'AC_list',
    ...
    def test_03_multi_scenario_of_architecture(self):
        ...
        dict_values = {
            f'{self.study_name}.multi_scenarios.activation_df_trade': [
                activation_df_1,
                activation_df_2,
            ],
            f'{self.study_name}.multi_scenarios.trade_variables': {
