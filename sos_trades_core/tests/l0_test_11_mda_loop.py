...
class TestMDALoop(unittest.TestCase):
    ...
    def test_03_mda_loop_after_dump_load(self):
        ...
        exec_eng.execute()
        norm0 = exec_eng.root_process.sub_mda_list[0].norm0
        normed_residual = exec_eng.root_process.sub_mda_list[0].normed_residual
        ...
        residual_history_output = exec_eng.dm.get_disciplines_with_name('EE')[0].get_sosdisc_outputs(
            'residuals_history')[exec_eng.root_process.sub_mda_list[0].name].values.tolist()
        ...
        norm0 = exec_eng2.root_process.sub_mda_list[0].norm0
        normed_residual = exec_eng2.root_process.sub_mda_list[0].normed_residual
        ...
        for key in target:
            ...
            if target[key] is dict:
                ...
                self.assertListEqual(
                    list(target[key]), list(res[key]))
        residual_history_2 = exec_eng2.root_process.sub_mda_list[0].residual_history
        residual_history_output_2 = exec_eng2.dm.get_disciplines_with_name('EE')[0].get_sosdisc_outputs(
            'residuals_history')[exec_eng2.root_process.sub_mda_list[0].name].values.tolist()
        ...
        norm0 = exec_eng3.root_process.sub_mda_list[0].norm0
        normed_residual = exec_eng3.root_process.sub_mda_list[0].normed_residual
        ...
        for key in target:
            ...
            if target[key] is dict:
                ...
                self.assertListEqual(
                    list(target[key]), list(res[key]))
        residual_history_3 = exec_eng3.root_process.sub_mda_list[0].residual_history
        residual_history_output_3 = exec_eng3.dm.get_disciplines_with_name('EE')[0].get_sosdisc_outputs(
            'residuals_history')[exec_eng3.root_process.sub_mda_list[0].name].values.tolist()
        ...
        exec_eng4.execute()
        residual_history_4 = exec_eng4.root_process.sub_mda_list[0].residual_history
        residual_history_output_4 = exec_eng4.dm.get_disciplines_with_name('EE')[0].get_sosdisc_outputs(
            'residuals_history')[exec_eng4.root_process.sub_mda_list[0].name].values.tolist()
    ...
    def test_04_two_mdas_loop_comparison(self):
        ...
        residual_history2 = exec_eng2.root_process.sub_mda_list[0].residual_history
    ...
    def test_06_mda_loop_with_discipline_grouping(self):
        ...
        mdo_chain = exec_eng.root_process.mdo_chain.disciplines[0].disciplines[0]
    ...
    def test_07_check_no_self_coupled_soscoupling(self):
        ...
        mda_builder = exec_eng.factory.get_builder_from_process(
            'sos_trades_core.sos_processes.test', 'test_sellar_coupling')
        ...
        sub_coupling = exec_eng.root_process.mdo_chain.disciplines[0]
        assert sub_coupling.__class__.__name__ == "SoSCoupling"
...
if '__main__' == __name__:
    cls = TestMDALoop()
    cls.setUp()
    cls.test_11_mda_numerical_options_GSorNR()
