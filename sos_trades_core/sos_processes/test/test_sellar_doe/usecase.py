...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        # SLSQP, NLOPT_SLSQP
        disc_dict[f'{ns}.SellarDoeScenario.algo'] = "lhs"
        disc_dict[f'{ns}.SellarDoeScenario.design_space'] = dspace
        # TODO: what's wrong with IDF
        disc_dict[f'{ns}.SellarDoeScenario.formulation'] = 'MDF'
        # f'{ns}.SellarDoeScenario.obj'
        disc_dict[f'{ns}.SellarDoeScenario.objective_name'] = 'obj'
        # disc_dict[f'{ns}.SellarDoeScenario.ineq_constraints'] = ['c_1', 'c_2'] # TBC_DM
        # f'{ns}.SellarDoeScenario.c_1', f'{ns}.SellarDoeScenario.c_2']

        disc_dict[f'{ns}.SellarDoeScenario.algo_options'] = {"ftol_rel": 1e-10,
                                                             "ineq_tolerance": 2e-3,
