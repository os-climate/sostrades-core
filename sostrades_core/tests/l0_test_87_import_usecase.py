...
class TestSoSimportUsecase(unittest.TestCase):
    ...
    def test_1_usecase_import_multi_instances_eval_simple_disc1_disc3(self):
        ...
        imported_module = import_module(f'{repo_name}.{proc_name}.{usecase_name}')
        ...
        ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.ReferenceScenario.Disc1')[0]
        ...
        print_flag = False
        self.check_discipline_values(ref_disc, target_values_dict, print_flag=print_flag)
        ...
        if self.with_modal:
            ...
            dict_values[f'{self.study_name}.Eval.sub_process_inputs'] = (
                process_builder_parameter_type.to_data_manager_dict()
            )
        else:
    ...
    def _test_3_usecase_import_mono_instances_eval_generator_doe_disc1_disc3(self):
        ...
        self.exec_eng.display_treeview_nodes()
        ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.{coupling_name}.Disc1')[0]
    ...
    def test_4_usecase_import_multi_instances_eval_simple_sellar(self):
        ...
        ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.ReferenceScenario.Sellar_1')[0]
        ...
        if based_on_uc_name:
            ...
            anonymize_input_dict_from_usecase = {}
            anonymize_input_dict_from_usecase['<study_ph>.x'] = [1.0]
            anonymize_input_dict_from_usecase['<study_ph>.y_1'] = [1.0]
            anonymize_input_dict_from_usecase['<study_ph>.y_2'] = [1.0]
            anonymize_input_dict_from_usecase['<study_ph>.z'] = [1.0, 1.0]
            anonymize_input_dict_from_usecase['<study_ph>.Sellar_Problem.local_dv'] = 10.0
    ...
    def test_5_usecase_import_multi_instances_eval_generator_cp_sellar(self):
        ...
        # Associated nested subprocess
        sub_process_name = 'test_sellar_coupling' if with_coupling else 'test_sellar_list'
        ...
        if with_coupling:
            ref_disc = self.exec_eng.dm.get_disciplines_with_name(
                f'{self.study_name}.Eval.ReferenceScenario.SellarCoupling.Sellar_1'
            )[0]
        else:
            ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.ReferenceScenario.Sellar_1')[
                0
            ]
        ...
        if based_on_uc_name:
            ...
            if with_coupling:
                ...
                anonymize_input_dict_from_usecase = {}
                anonymize_input_dict_from_usecase['<study_ph>.SellarCoupling.x'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.SellarCoupling.y_1'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.SellarCoupling.y_2'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.SellarCoupling.z'] = [1.0, 1.0]
                anonymize_input_dict_from_usecase['<study_ph>.SellarCoupling.Sellar_Problem.local_dv'] = 10.0
    ...
    def _test_6_usecase_import_mono_instances_eval_generator_doe_sellar(self):
        ...
        if with_coupling:
            ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.SellarCoupling.Sellar_1')[0]
        else:
            ref_disc = self.exec_eng.dm.get_disciplines_with_name(f'{self.study_name}.Eval.subprocess.Sellar_1')[0]
        ...
        if based_on_uc_name:  # full anonymized dict with numerical keys
            ...
            if with_coupling:
                ...
                # csv anonymised dict import.
                anonymize_input_dict_from_usecase = {}
                anonymize_input_dict_from_usecase['<study_ph>.subprocess.x'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.subprocess.y_1'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.subprocess.y_2'] = [1.0]
                anonymize_input_dict_from_usecase['<study_ph>.subprocess.z'] = [1.0, 1.0]
                anonymize_input_dict_from_usecase['<study_ph>.subprocess.Sellar_Problem.local_dv'] = 10.0
    ...
    def test_8_usecase_import_multi_instances_basic_Disc1Disc3(self):
        ...
        self.exec_eng.display_treeview_nodes()
        ref_disc = self.exec_eng.dm.get_disciplines_with_name(
            f'{self.study_name}.multi_scenarios.ReferenceScenario.Disc1'
        )[0]
        ...
        if self.with_modal:
            ...
            process_builder_parameter_type.usecase_data = anonymize_input_dict_from_usecase
            # process_builder_parameter_type.usecase_data = {}
            dict_values[f'{self.study_name}.multi_scenarios.sub_process_inputs'] = (
                process_builder_parameter_type.to_data_manager_dict()
            )
        else:
