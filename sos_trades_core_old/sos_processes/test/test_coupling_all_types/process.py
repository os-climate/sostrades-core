...
class ProcessBuilder(BaseProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Core Test Disc1 Disc2 Coupling Process All Types',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        mods_dict = {'Disc1': disc_dir + 'disc1_all_types.Disc1',
                     'Disc2': disc_dir + 'disc_out_all_types.DiscOutAllTypes'}
        builder_list = self.create_builder_list(mods_dict, ns_dict={'ns_test': f'{self.ee.study_name}.Disc1'})
