...
class ProcessBuilder(BaseProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Core Test Sellar Coupling with Types Filter Process',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        disc_dir = 'sos_trades_core.sos_wrapping.test_discs.sellar_types_filter.'
        ...
        builder_list = self.create_builder_list(mods_dict,
                                                ns_dict={'ns_OptimSellar': self.ee.study_name + '.SellarCoupling'})
